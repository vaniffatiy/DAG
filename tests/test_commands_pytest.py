...
@pytest.fixture
def commands():
    return Commands([1]*10)


@pytest.fixture
def hospital(commands):
    return commands.hospital


class TestCommands:
    def test_calculate_statistics(self, mocker, commands):
    ...
    def test_calculate_statistics_after_changes(self, mocker, commands, hospital):
        mock_communicator = mocker.patch("app.communicator.Communicator.print_info")
    ...
    def test_upgrade_status_with_valid_value(self, mocker, commands):
    ...
    def test_upgrade_status_with_invalid_value(self, mocker, commands):
    ...
    def test_upgrade_status_with_nonexistent_value(self, mocker, commands):
        mock_print_info = mocker.patch("app.communicator.Communicator.print_info")
        mock_get_id = mocker.patch("app.communicator.Communicator.get_id")
    ...
    def test_upgrade_status_with_patient_valid_for_discharge(self, mocker, commands):
    ...
    def test_upgrade_status_with_patient_invalid_for_discharge(self, mocker, commands):
        mock_valid_check = mocker.patch("app.hospital.Hospital.is_patient_valid_for_status_upgrade")
